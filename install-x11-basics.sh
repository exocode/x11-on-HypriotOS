...
FBTURBO_TAR_URL=https://github.com/exocode/x11-on-HypriotOS/raw/master/fbturbo/${PI_VERSION}/fbturbo.tar.gz
...
if [ "${PI_VERSION}" == "pi3" ]; then
    ...
    XORG_CONF_URL=https://github.com/exocode/x11-on-HypriotOS/raw/master/fbturbo/${PI_VERSION}/xorg.conf
